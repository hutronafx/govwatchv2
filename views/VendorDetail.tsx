  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-12">
      ...
      <div className="bg-gw-card border border-gw-border rounded-lg p-8 shadow-lg">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <h1 className="text-2xl font-bold text-white break-words">{vendorName}</h1>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* CHART */}
          <div className="bg-gw-card border border-gw-border rounded-lg p-6 flex flex-col min-h-[300px]">
             ...
             <div className="mt-4 space-y-2 max-h-[150px] overflow-y-auto pr-2 custom-scrollbar">
                 {chartData.map((item, index) => (
                     <div key={index} className="flex justify-between items-center text-xs">
                         ...
                         <span className="font-mono text-gw-muted">{formatMoney(item.value, language)}</span>
                     </div>
                 ))}
             </div>
          </div>
                ...
                <div key={r.id} className="bg-gw-card border border-gw-border rounded-lg p-5 hover:border-gw-muted/50 transition-colors relative">
                    ...
                    <div className="flex flex-col md:flex-row justify-between md:items-start gap-4 mb-2 pr-8">
                         <button 
                            ...
                            className="text-white font-bold hover:text-blue-400 transition-colors text-left text-lg block"
                         >
                    ...
                    <div className="flex items-center gap-4 text-sm text-gw-muted mb-3">
                    ...
                    {r.title && <div className="text-sm text-gw-text mb-2 italic">"{r.title}"</div>}
